...
const Contents = () => {
  ...
  return (
    <section className="max-container pt-7 md:pt-10 px-3">
      <section>
        <header>
          ...
          <aside className="overflow-x-auto w-[700px] max-md:max-w-[100%] mx-auto">
            <div className="w-full bg-gradient-to-br from-yellow-50 via-cyan-500 to-blue-800 py-2 mt-6 mb-3">
