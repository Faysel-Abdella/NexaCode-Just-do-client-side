...
const Steps = () => {
  return (
    <section className="mt-24 px-5  w-full">
      <div className=" max-lg:w-full mb-20  lg:pr-[25px]">
        <Step
          img={assets.kids}
          isReverse={true}
          ...
          <div className="flex max-[800px]:flex-col items-center gap-8">
            ...
            <div>
              ...
              <h2 className="text-[#006CD8] text-[15px] font-medium lg:text-[28px]">
                Speaking practice is not necessarily limited to language
                learning.
              </h2>
              ...
              <ul>
                ...
                <li className="text-fade text-[15px] lg:text-[24px]">
                  • memorize anything important like economic terms, medical
                  words and so on.
                </li>
              </ul>
            </div>
      ...
      <div className=" max-lg:w-full mb-20 m-0  lg:pr-[25px]">
        <Step
          img={assets.kids}
          isReverse={true}
